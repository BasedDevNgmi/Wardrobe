...
export const FR_FLOURS: FlourDecl[] = [
  decl({
    ...
    protein: 10.5, proteinBasis: 'dry', ash: 0.45, extraction: 67,
  ...
  decl({
    ...
    protein: 11.0, proteinBasis: 'dry', ash: 0.55, extraction: 72,
  ...
  decl({
    ...
    protein: 11.5, proteinBasis: 'dry', ash: 0.68, extraction: 78,
  ...
  decl({
    ...
    protein: 11.3, proteinBasis: 'dry', ash: 0.68, extraction: 78,
    species: 'wheat', wholegrain: 0.05, mill: 'roller', hardness: 'medium',
  ...
  decl({
    ...
    protein: 11.8, proteinBasis: 'dry', ash: 0.85, extraction: 82,
  ...
  decl({
    ...
    protein: 12.0, proteinBasis: 'dry', ash: 1.15, extraction: 88,
  ...
  decl({
    ...
    protein: 12.5, proteinBasis: 'dry', ash: 1.6, extraction: 100,
  ...
  decl({
    ...
    protein: 11.5, proteinBasis: 'dry', ash: 0.88, extraction: 83,
  ...
  decl({
    ...
    protein: 10.5, proteinBasis: 'dry', ash: 0.55, extraction: 72,
  ...
  decl({
    ...
    protein: 11.0, proteinBasis: 'dry', ash: 0.7, extraction: 79,
